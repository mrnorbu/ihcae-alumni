          ...
          <div class="px-4 py-5 sm:p-6">
            <div class="flex items-center mb-4">
              ...
              <div class="ml-4">
                ...
                <p class="text-sm text-gray-500">Connect with fellow alumni and share your experiences</p>
              </div>
            </div>
            <div class="space-y-3 mb-4">
              <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div class="flex items-center">
                  ...
                  <span class="text-sm font-medium text-gray-900">Mountaineering Discussions</span>
                </div>
                <span class="text-xs text-gray-500">12 active</span>
              </div>
              <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div class="flex items-center">
                  <div class="w-2 h-2 bg-blue-400 rounded-full mr-3"></div>
                  <span class="text-sm font-medium text-gray-900">Conservation Projects</span>
                </div>
                <span class="text-xs text-gray-500">8 active</span>
              </div>
              <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div class="flex items-center">
                  <div class="w-2 h-2 bg-purple-400 rounded-full mr-3"></div>
                  <span class="text-sm font-medium text-gray-900">Alumni Stories</span>
                </div>
                <span class="text-xs text-gray-500">15 active</span>
              </div>
            </div>
