    ...
    <div class="min-h-screen bg-neutral-50">
      ...
      <div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8 pt-24">
        ...
        <div *ngIf="!isLoading() && profile()" class="space-y-6">
              ...
              <div class="flex items-end -mt-16 mb-4">
                ...
                <div class="relative">
                  <div class="w-32 h-32 rounded-full border-4 border-white overflow-hidden bg-neutral-200 flex items-center justify-center">
                    <img
                      *ngIf="profile()?.profileImageUrl && !isLucideIconUrl(profile()!.profileImageUrl)"
          ...
          <!-- Edit Mode Actions -->
          <div *ngIf="isEditMode()" class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 flex items-center justify-between">
          ...
          <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                />
                <p *ngIf="!isEditMode()" class="text-neutral-900">
            ...
            <div class="mt-6">
              ...
              ></textarea>
              <p *ngIf="!isEditMode()" class="text-neutral-900 whitespace-pre-wrap">
