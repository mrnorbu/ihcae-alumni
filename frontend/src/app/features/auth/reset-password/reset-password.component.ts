    ...
    <div class="min-h-screen flex">
      ...
      <div class="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-neutral-50">
        <div class="w-full max-w-md">
          ...
          <div *ngIf="isTokenInvalid()" class="space-y-6">
          ...
          <!-- Success State -->
          <div *ngIf="isPasswordReset()" class="space-y-6">
            <div class="text-center mb-6">
          ...
          <!-- Form State -->
          <div *ngIf="!isTokenInvalid() && !isPasswordReset()">
            <div class="bg-white rounded-lg shadow-sm border border-neutral-200 p-8">
              ...
              <form [formGroup]="resetPasswordForm" (ngSubmit)="onSubmit()" class="space-y-4">
                ...
                <div class="form-group">
                  ...
                  />
                  <div *ngIf="resetPasswordForm.get('password')?.invalid && resetPasswordForm.get('password')?.touched" class="form-error">
                    <p *ngIf="resetPasswordForm.get('password')?.errors?.['required']">Password is required</p>
                    <p *ngIf="resetPasswordForm.get('password')?.errors?.['minlength']">Password must be at least 8 characters</p>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  />
                  <div *ngIf="resetPasswordForm.get('confirmPassword')?.invalid && resetPasswordForm.get('confirmPassword')?.touched" class="form-error">
                    <p *ngIf="resetPasswordForm.get('confirmPassword')?.errors?.['required']">Please confirm your password</p>
                    <p *ngIf="resetPasswordForm.get('confirmPassword')?.errors?.['mismatch']">Passwords do not match</p>
                  </div>
                </div>
