  ...
  template: `
    <div class="min-h-screen bg-neutral-50">
      ...
      <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <!-- Articles Tab -->
        <div *ngIf="!isLoading() && activeTab() === 'articles'" class="space-y-4">
          <div *ngFor="let article of getFilteredArticles()" class="card">
                ...
                <div class="flex items-start justify-between">
                  <div>
                    ...
                    <div class="flex items-center gap-4 text-xs text-neutral-500">
                      ...
                      <span *ngIf="article.updatedAt">Updated: {{ formatDate(article.updatedAt) }}</span>
                      <span>By: {{ article.authorName }}</span>
                    </div>
                  </div>
                  <div class="flex items-center gap-2">
                    <span *ngIf="article.isPublished" class="badge badge-success">Published</span>
                    <span *ngIf="!article.isPublished" class="badge badge-warning">Draft</span>
          ...
          <div *ngIf="getFilteredArticles().length === 0" class="card text-center py-12">
        ...
        <!-- Events Tab -->
        <div *ngIf="!isLoading() && activeTab() === 'events'" class="space-y-4">
          <div *ngFor="let event of getFilteredEvents()" class="card">
            <div class="flex items-start gap-4">
              <div class="w-16 h-16 bg-neutral-100 rounded-lg flex items-center justify-center flex-shrink-0">
              ...
              <div class="flex-1 min-w-0">
                <div class="flex items-start justify-between">
                  ...
                  <div class="flex items-center gap-2">
                    <span *ngIf="event.isPublished" class="badge badge-success">Published</span>
                    <span *ngIf="!event.isPublished" class="badge badge-warning">Draft</span>
                    <div class="flex items-center gap-1">
                      <button
          ...
          <div *ngIf="getFilteredEvents().length === 0" class="card text-center py-12">
      ...
      <div *ngIf="showArticleModal()" class="modal-overlay" (click)="closeArticleModal()">
            ...
            <form (ngSubmit)="saveArticle()" class="space-y-4">
              ...
              <div class="flex items-center justify-end gap-3">
                ...
                <button type="submit" class="btn-primary" [disabled]="isSaving()">
                  <lucide-icon *ngIf="!isSaving()" [img]="saveIcon" [size]="16"></lucide-icon>
                  <lucide-icon *ngIf="isSaving()" [img]="refreshIcon" [size]="16" class="animate-spin"></lucide-icon>
