...
-- First, let's clean up any problematic data with invalid UUIDs (in correct order)
-- Delete child records first
DELETE FROM DiscussionTopicTags WHERE TopicId LIKE '4444444%' OR TopicId LIKE '6666666%' OR TopicId LIKE '8888888%';
DELETE FROM PostLikes WHERE PostId LIKE 'p4444444%' OR PostId LIKE 'p6666666%' OR PostId LIKE 'p8888888%' OR PostId LIKE 'r4444444%' OR PostId LIKE 'r6666666%' OR PostId LIKE 'r8888888%';

-- Delete replies first (they reference posts)
DELETE FROM ForumPosts WHERE Id LIKE 'r4444444%' OR Id LIKE 'r6666666%' OR Id LIKE 'r8888888%';

-- Delete posts (they reference topics)
DELETE FROM ForumPosts WHERE Id LIKE 'p4444444%' OR Id LIKE 'p6666666%' OR Id LIKE 'p8888888%';
