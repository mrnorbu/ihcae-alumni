-- Simple Forum Data Creation Script with Proper UUIDs
...
-- Create some likes for posts and replies
INSERT INTO PostLikes (Id, PostId, UserId, CreatedAt) VALUES
-- Likes for main posts
(UUID(), @post1, '11111111-1111-1111-1111-111111111111', NOW() - INTERVAL 4 DAY),
(UUID(), @post1, '22222222-2222-2222-2222-222222222222', NOW() - INTERVAL 3 DAY),
(UUID(), @post1, '33333333-3333-3333-3333-333333333333', NOW() - INTERVAL 2 DAY),
(UUID(), @post1, '44444444-4444-4444-4444-444444444444', NOW() - INTERVAL 1 DAY),

(UUID(), @post2, '11111111-1111-1111-1111-111111111111', NOW() - INTERVAL 3 DAY),
(UUID(), @post2, '33333333-3333-3333-3333-333333333333', NOW() - INTERVAL 2 DAY),
(UUID(), @post2, '55555555-5555-5555-5555-555555555555', NOW() - INTERVAL 1 DAY),

(UUID(), @post3, '204480b7-8f40-428f-9cca-04670ecde8ce', NOW() - INTERVAL 2 DAY),
(UUID(), @post3, '22222222-2222-2222-2222-222222222222', NOW() - INTERVAL 1 DAY),
(UUID(), @post3, '44444444-4444-4444-4444-444444444444', NOW() - INTERVAL 12 HOUR);
